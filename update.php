...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE student SET name = ?, section = ?, age = ?, cgpa = ? WHERE roll = ?";
    ...
    mysqli_stmt_bind_param($stmt, "ssidi", $txtname, $txtsection, $txtage, $txtcgpa, $txtroll);
    ...
    if ($result) {
        ...
        echo "<p style='color: red; font-weight: bold;'>Error updating record: " . mysqli_error($con) . "</p>";
    }
